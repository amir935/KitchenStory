                ...
                <Router>
                    <div className="container">
                        <nav className="navbar navbar-expand-xl navbar-dark bg-primary">
                            <Link to={'/'} className="navbar-brand">Amir's Kitchen</Link>
                            ...
                            <div className="collapse navbar-collapse" id="collapsibleNavbar">
                                <ul className="navbar-nav mr-auto">
                                    <li className="nav-item">
                                        <Link to={'/items'} className="nav-link" style={{ color: "white" }}>Browse Foods</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link to={'/itemAdd'} className="nav-link" style={{ color: "white" }}>Add Food</Link>
                                    </li>
                                </ul>
