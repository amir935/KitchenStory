    ...
    render() {
        return (
            <div className="container">
                <h1 className="title" style={{ color: "green", marginTop: "0.5%", fontSize: 30 }}>Welcome {getUser() !== null ? getUser().name : ""} to Amir's Kitchen </h1><br />
                    ...
                    <div className="container" style={{ marginBottom: "50px" }}>
                        {
                            this.state.items.length > 0 ?
                                <div className="container" style={{ marginTop: 20 }}>
                                    <div className="alert alert-success" role="alert">Yes !! You found some foods.</div>
